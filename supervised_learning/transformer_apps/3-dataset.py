#!/usr/bin/env python3
"""Defines the Dataset class for loading and prepping a translation dataset"""
...
class Dataset:
    ...
    def __init__(self, batch_size, max_len):
        ...
        def filter_max_length(pt, en, max_length=max_len):
            """Keeps only examples where both sentences fit max_length"""
            return tf.logical_and(
                tf.size(pt) <= max_length, tf.size(en) <= max_length)
