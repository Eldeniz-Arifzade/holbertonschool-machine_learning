...
class NST:
    ...
    style_outputs: list of tf.Tensor containing style layer outputs

    Returns: style cost (tf.Tensor)
    """
    ...
    def layer_style_cost(self, style_output, gram_target):
        ...
        Args:
            style_output (tf.Tensor): shape (1, h, w, c)
            gram_target (tf.Tensor): shape (1, c, c)
        ...
        # squared error
        diff = tf.square(gram_style - gram_target)
